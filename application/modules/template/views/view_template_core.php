...
<head>
    ...
    <link href="<?php echo base_url();?>assets/src/assets/css/dark/components/tabs.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url(); ?>assets/src/assets/css/light/components/tabs.css" rel="stylesheet" type="text/css" />
            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        ...
                        <div class="dropdown-item">
                            <a href="<?php echo base_url('login/logoutApp') ?>">
    ...
    <div class="main-container" id="container">
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <?php if($this->uri->segment('1') == 'hospot_user'){ ?>
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="users" data-bs-parent="#accordionExample">
                            <li class="active">
                             <a href="<?php echo base_url('hospot_user'); ?>"> Hospot User </a>
                         </li>
                         <li>
                            <a href="./user-account-settings.html"> PPP Users </a>
