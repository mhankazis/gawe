                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-flag-dropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="" src=" <?php echo base_url(); ?>assets/images/flags/us.jpg" alt="Header Language" height="14">
                            </button>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="d-none d-sm-inline-block ml-1"><?php echo $woy['username'] ; ?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="<?php echo base_url('login/logoutApp') ?>"><i class="mdi mdi-logout font-size-16 align-middle mr-1"></i> Logout</a>
                            </div>
                        </div>
